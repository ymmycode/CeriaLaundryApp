 ...
 * @author achma
 */
public class CetakLaporanPelanggan extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form CetakLaporanPelanggan
     */
    public CetakLaporanPelanggan(String month, String year) {
        try {
            initComponents();
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = getClass().getResourceAsStream("/report/LaporanPelanggan.jrxml");
            ...
            sql = "SELECT\n" +
                    ...
                    "WHERE\n" +
                    "	pelanggan.tglBuat LIKE '%"+nowTime+"%'";
