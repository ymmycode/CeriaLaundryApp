 ...
 * @author achma
 */
public class CetakLaporanPendapatan extends javax.swing.JInternalFrame {
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = getClass().getResourceAsStream("/report/LaporanPendapatan.jrxml");
