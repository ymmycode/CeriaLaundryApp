 ...
 * @author achma
 */
public class CetakLaporanPengeluaran extends javax.swing.JInternalFrame {
    Connection connection;
    java.sql.Statement stat,stat1,stat2;
    ResultSet rs;
    String total, sql, sql1, sql2, roleDB, nowTime;
    /**
     * Creates new form CetakLaporanPengeluaran
     */
    public CetakLaporanPengeluaran(String month, String year) {
        try {
            initComponents();
    ...
    private void Process() throws FileNotFoundException
    {
        try{
            ...
            Map prs = new HashMap();            
            InputStream filePath = getClass().getResourceAsStream("/report/LaporanPengeluaran.jrxml");
            ...
            sql = "SELECT\n" +
                    ...
                    "	pengeluaran\n" +
                    "WHERE\n" +
                    "	pengeluaran.tglBuat LIKE '%"+nowTime+"%'";
